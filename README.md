...
| ------------ | --------------------------------------------------------------------------------------------------------- | ---------------- | --- |
| `index.html` | Gábor OS – személyes önfejlesztési dashboard (Feelfit, Garmin, böjt-streak, napirend)                     | 2026.09.10. (v5.2) | – |
| `rosas.html` | Rosas Logisztikai Kft. – belső céges dashboard (pénzügy, KPI projekt, marketing átvétel, EU AI Act/GDPR)  | 2026.09.10.      | – |
| `README.md`  | Ez a fájl                                                                                                  | 2026.09.10.      | – |
...
📝 **Rendszerprompt – mesterpéldány és tartalék** (2026.08.02. óta): a Rosas rendszerprompt **mesterpéldánya egy `.txt` fájl**, amelyet Gábor ment el és tölt vissza — **nem a Notion-lap**. A Notionban élő 📝 másolat ettől kezdve **TARTALÉK**: célja továbbra is, hogy Projekten kívüli beszélgetésben se kelljen manuálisan bemásolni, de a frissítése **RITKÍTOTT** (négy verziónként · strukturális változáskor · ha a mesterfájl elvész · projekten kívüli munkamenet előtt), ezért **egy vagy több verzióval hátrébb lehet** a mesterfájlnál. Mielőtt forrásként használnád, nézd meg a verziószámát. Lásd a `rosas-session-close` Skill **1/b** és **6.** pontját.
...
| Dátum       | Mi változott                                                                                                                                                                                                                                                                                                                                                                                                      |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026.09.10. | **v5.2** — 🛟 CSAK a vész-`FALLBACK` frissítve (Gábor kérésére): a 07.20–07.22-i értékek helyett a trend-napló metrikánként utolsó nem-üres értékei (HRV 35 · pulzus 54 · alvás 63 · lépés 5296 · súly 92.05 · zsigeri 14 · testzsír 31.8 · izom 59.6 · BMR 1726 · böjt 14.6). A fallback csak akkor látszik, ha a Notion nem elérhető. Egyéb változás nincs: se oszlop, se parser, se küszöb. |
| 2026.07.30. | **v5.1** — 🩸 A megígért vérvétel számlálója KIVEZETVE: a 2026.07.13-án megígért vérvétel 2026.07.27-én megtörtént, a számláló tárgytalanná vált. ⚠️ **2026.08.30-i README-javítás:** ez a sor eddig hiányzott a changelogból, és a Fájlok tábla tévesen v5.0-t írt. A README származtatott másolat, a kanonikus forrás a repo – ezért mostantól minden dashboard-változtatásnál egy plusz lépés a README frissítése (Gábor „A" döntése, 2026.08.30.). |
...
| Dátum       | Mi változott                                                                                                                                                                   |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026.09.10. | **Kézi szinkron 48 nap után** (30 157 → 36 386 bájt, 336 → 367 sor, `fetch()` továbbra is 0). Javítva: **öt lejárt határidő**, amely élő határidőként állt (07.31. ×3, 08.02.); **két relatív időmegjelölés** abszolút dátum nélkül („pótlás e héten", „1-2 héten belül") — ez a rendszerprompt v4.60 szabályának élő megsértése volt; a marketing-szolgáltatói szál „visszaigazolásra várunk" állítása (a megállapodás 2026.07.29. óta lezárt); és egy téves létszám (18 → 19). Bekerült: az ügyvédi megbízás kétoldalú aláírása, két jogi állásfoglalás, a lezárt AI-jártassági oktatás, a leállított weboldali chatbot, a szerkesztői felelős kijelölése, a harmadik országbeli tárolás, a 11.30-i adatkimentési véghatáridő, valamint három új „Folyamatban" és kilenc új „Elvégzett" projektkártya. ⚠️ Az adatvédelmi szabály (`rosas-dashboard` 2a.) kontrollja lefutott: nevesített ügyfélre, szolgáltatóra, munkavállalóra és konkrét tárgyalási árra **0 találat**. A szerkesztői felelős NEVE szándékosan nem került fel — a közzététel jogalapja ügyvédi állásfoglalásra vár. |
...
| Dátum       | Mi változott                                                                                                                                                                                                                                                                                            |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026.09.10. | Fájlok tábla: `rosas.html` 2026.07.24. → **2026.09.10.** Rosas changelog: új sor a 48 nap utáni kézi szinkronról. ⚠️ **Ez a 2026.08.30-i szabály („minden dashboard-változtatásnál egy plusz lépés a README frissítése", Gábor „A" döntése) második éles alkalmazása a Rosas oldalon** — és majdnem kimaradt: a `rosas.html` már fel volt töltve, amikor a záró ellenőrzés a README élő olvasásán megfogta, hogy a fájltábla még a régi dátumot hordozza. |
| 2026.09.10. | Fájlok tábla: `index.html` → 2026.09.10. (v5.2), `README.md` → 2026.09.10. Gábor OS changelog: új v5.2 sor. |
| 2026.08.02. | **Javítás (osztály-szintű, a `rosas-audit-policy` v2.3 és a `rosas-konfliktus-feloldas` v1.2 kiadásával egy körben).** Az 54. sor azt állította, hogy a Notionban élő 📝 lap „a mindenkori Rosas rendszerprompt 1:1 másolata" — ez 2026.08.02. óta **hamis**: a mesterpéldány egy `.txt` fájl, a Notion-lap tartalék, ritkított frissítéssel. Működési következmény: az olvasó forrásnak hihette a lapot, és egy elavult promptból indíthatott munkamenetet. Emellett a Fájlok táblázat `README.md` sorában az „utolsó frissítés (kód)" 2026.07.02. → **2026.08.02.** — ez a Rosas ⚖️ Döntési Napló `q)` sorában megjegyzés-szintű elavulásként állt, és a szabály szerint akkor rendezendő, amikor a fájlhoz úgyis hozzányúlunk. ⚠️ **A 35. sor (a Gábor OS párja, szó szerint ugyanez a mondat) szándékosan ÉRINTETLEN** — kereszt-projekt tétel, a Rosas oldalról nem javítható egyoldalúan (`vezetoi-alapelvek` 7/K). |
